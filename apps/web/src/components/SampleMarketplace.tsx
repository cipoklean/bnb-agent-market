"use client";
// SAMPLE MODE (dev-only, NEXT_PUBLIC_SAMPLE_DATA=1): the original mock
// marketplace, preserved verbatim against SAMPLE_AGENTS. Never used in the
// production path (live directory is lib/scan-server.ts listAgents).
...
export default function SampleMarketplace() {
  ...
  const agents = useMemo(() => {
    ...
    let list = [...submittedAgents, ...SAMPLE_AGENTS].filter((a) => {
